		...
		<div className={styles.container}>
			<div className={styles.grid}>
				...
				<div className={styles.card}>
					<Card>
						<h2>
							<Icon.User01 size="lg" /> My Position
						</h2>
				...
				<div className={styles.card}>
					<Card>
						<h2>
							<Icon.Activity size="lg" /> Active Auctions
						</h2>
			...
			<div className={styles.fullCard}>
				<Card>
					<h3>
						<Icon.CpuChip01 size="lg" /> Autonomous Execution Primitives
					</h3>
					<p>
						LendX leverages <strong>x402</strong> and{" "}
						<strong>Action Model Programming</strong> to handle liquidations
					...
					<div className={styles.primitiveList}>
						<div className={styles.primitive}>
							...
							<p>
								Watches Health Factors and triggers Dutch Auctions for 0.1% fee.
							</p>
						</div>
						<div className={styles.primitive}>
							<strong>Bidder Agent</strong>
							<p>
								Monitors auctions and bids when the discount reaches
								profitability.
							</p>
						</div>
						<div className={styles.primitive}>
							...
							<p>
								Settles debt and returns surplus to borrower in one Stellar
								transaction.
							</p>
						</div>
					</div>
